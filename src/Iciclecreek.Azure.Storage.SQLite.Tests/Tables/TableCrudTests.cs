...
public class TableCrudTests
{
    ...
    {
        var client = SqliteTableClient.FromAccount(_db.Account, "people");
    ...
    {
        var client = SqliteTableClient.FromAccount(_db.Account, "dup-table");
        client.CreateIfNotExists();
    ...
    {
        var client = SqliteTableClient.FromAccount(_db.Account, "upsert");
        client.CreateIfNotExists();
    ...
    {
        var client = SqliteTableClient.FromAccount(_db.Account, "merge");
        client.CreateIfNotExists();
    ...
    {
        var client = SqliteTableClient.FromAccount(_db.Account, "del-table");
        client.CreateIfNotExists();
    ...
    {
        var client = SqliteTableClient.FromAccount(_db.Account, "etag-table");
        client.CreateIfNotExists();
    ...
    {
        var client = SqliteTableClient.FromAccount(_db.Account, "etag-all");
        client.CreateIfNotExists();
    ...
    {
        var client = SqliteTableClient.FromAccount(_db.Account, "etag-track");
        client.CreateIfNotExists();
    ...
    {
        var client = SqliteTableClient.FromAccount(_db.Account, "etag-optimistic");
        client.CreateIfNotExists();
    ...
    {
        var client = SqliteTableClient.FromAccount(_db.Account, "etag-del");
        client.CreateIfNotExists();
    ...
    {
        var client = SqliteTableClient.FromAccount(_db.Account, "etag-del-ok");
        client.CreateIfNotExists();
