...
public class TableQueryTests
{
    ...
    private SqliteTableClient SetupPeopleTable()
    {
    ...
    {
        var service = SqliteTableServiceClient.FromAccount(_db.Account);
    ...
    private async Task<SqliteTableClient> SetupPeopleTableAsync()
    {
        var client = SqliteTableClient.FromAccount(_db.Account, "people");
